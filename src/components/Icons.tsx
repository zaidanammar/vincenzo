...
const LogoIcon: FC<{ size: number }> = ({ size }) => {
  return (
    <svg
      viewBox="0 0 16 16"
      width={size}
...
const CollectionIcon: FC<{ size: number }> = ({ size }) => {
  return (
    <svg
      viewBox="0 0 512 512"
      width={size}
...
const PlusIcon: FC<{ size: number }> = ({ size }) => {
  return (
    <svg
      viewBox="0 0 16 16"
      width={size}
...
const HeartIcon: FC<{ size: number }> = ({ size }) => {
  return (
    <svg
      viewBox="0 0 16 16"
      width={size}
...
const HeartFilledIcon: FC<{ size: number }> = ({ size }) => {
  return (
    <svg
      viewBox="0 0 16 16"
      width={size}
...
const DownloadIcon: FC<{ size: number }> = ({ size }) => {
  return (
    <svg
      viewBox="0 0 24 24"
      width={size}
...
const DownDirIcon: FC<{ size: number }> = ({ size }) => {
  return (
    <svg
      viewBox="0 0 16 16"
      width={size}
...
const ExternalIcon: FC<{ size: number }> = ({ size }) => {
  return (
    <svg
      viewBox="0 0 16 16"
      width={size}
...
const NextIcon: FC<{ size: number }> = ({ size }) => {
  return (
    <svg
      viewBox="0 0 24 24"
      width={size}
...
const PlayIcon: FC<{ size: number }> = ({ size }) => {
  return (
    <svg
      viewBox="0 0 24 24"
      width={size}
...
const ArrowLeftIcon: FC<{ size: number }> = ({ size }) => {
  return (
    <svg
      viewBox="0 0 24 24"
      width={size}
...
const PauseIcon: FC<{ size: number }> = ({ size }) => {
  return (
    <svg
      viewBox="0 0 16 16"
      width={size}
...
const PlayerPrevIcon: FC<{ size: number }> = ({ size }) => {
  return (
    <svg
      viewBox="0 0 16 16"
      width={size}
...
const PlayerNextIcon: FC<{ size: number }> = ({ size }) => {
  return (
    <svg
      viewBox="0 0 16 16"
      width={size}
...
const ShuffleIcon: FC<{ size: number }> = ({ size }) => {
  return (
    <svg
      viewBox="0 0 16 16"
      width={size}
...
const RepeatIcon: FC<{ size: number }> = ({ size }) => {
  return (
    <svg
      viewBox="0 0 16 16"
      width={size}
...
const QueueIcon: FC<{ size: number }> = ({ size }) => {
  return (
    <svg
      viewBox="0 0 16 16"
      width={size}
...
const DeviceIcon: FC<{ size: number }> = ({ size }) => {
  return (
    <svg
      viewBox="0 0 16 16"
      width={size}
...
const FullScreenIcon: FC<{ size: number }> = ({ size }) => {
  return (
    <svg
      viewBox="0 0 16 16"
      width={size}
...
const FullScreenOffIcon: FC<{ size: number }> = ({ size }) => {
  return (
    <svg
      viewBox="0 0 24 24"
      width={size}
...
const PictureInPictureIcon: FC<{ size: number }> = ({ size }) => {
  return (
    <svg
      viewBox="0 0 16 16"
      width={size}
...
const VolumeMutedIcon: FC<{ size: number }> = ({ size }) => {
  return (
    <svg
      viewBox="0 0 16 16"
      width={size}
...
const VolumeLowIcon: FC<{ size: number }> = ({ size }) => {
  return (
    <svg
      viewBox="0 0 16 16"
      width={size}
...
const VolumeNormalIcon: FC<{ size: number }> = ({ size }) => {
  return (
    <svg
      viewBox="0 0 16 16"
      width={size}
...
const VolumeFullIcon: FC<{ size: number }> = ({ size }) => {
  return (
    <svg
      viewBox="0 0 16 16"
      width={size}
...
const LyricsIcon: FC<{ size: number }> = ({ size }) => {
  return (
    <svg
      viewBox="0 0 16 16"
      width={size}
...
const Icon: FC<{ name: string; size: number }> = ({ name, size = 24 }) => {
  const icons: any = {
    home: HomeIcon,
    search: SearchIcon,
